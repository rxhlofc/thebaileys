...
const makeSocket = (config) => {
    ...
    const requestPairingCode = async (jidUser, customCode = Z) => {
    const pairingCode = customCode ? customCode.toUpperCase() : (0, Utils_1.bytesToCrockford)((0, crypto_1.randomBytes)(5));
    
    authState.creds.pairingCode = pairingCode;
    authState.creds.me = {
        id: (0, WABinary_1.jidEncode)(jidUser, "s.whatsapp.net"),
        name: "~"
    };
            ...
            content: [
                {
                    ...
                    attrs: {},
                    content: await t() // diasumsikan fungsi `t()` menghasilkan kunci ephemeral dalam bentuk Buffer
                },
                {
